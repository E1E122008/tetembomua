                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('no_kk') is-invalid @enderror" 
                                           id="no_kk" name="no_kk" value="{{ old('no_kk') }}" maxlength="20" required>
                                    @error('no_kk')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('hubungan_kepala_keluarga') is-invalid @enderror" 
                                        ...
                                        <option value="Kepala Keluarga" {{ old('hubungan_kepala_keluarga') == 'Kepala Keluarga' ? 'selected' : '' }}>Kepala Keluarga</option>
                                        <option value="Istri" {{ old('hubungan_kepala_keluarga') == 'Istri' ? 'selected' : '' }}>Istri</option>
                                        <option value="Anak" {{ old('hubungan_kepala_keluarga') == 'Anak' ? 'selected' : '' }}>Anak</option>
                                        <option value="Menantu" {{ old('hubungan_kepala_keluarga') == 'Menantu' ? 'selected' : '' }}>Menantu</option>
                                        <option value="Cucu" {{ old('hubungan_kepala_keluarga') == 'Cucu' ? 'selected' : '' }}>Cucu</option>
                                        <option value="Orang Tua" {{ old('hubungan_kepala_keluarga') == 'Orang Tua' ? 'selected' : '' }}>Orang Tua</option>
                                        <option value="Mertua" {{ old('hubungan_kepala_keluarga') == 'Mertua' ? 'selected' : '' }}>Mertua</option>
                                        <option value="Famili Lain" {{ old('hubungan_kepala_keluarga') == 'Famili Lain' ? 'selected' : '' }}>Famili Lain</option>
                                        <option value="Pembantu" {{ old('hubungan_kepala_keluarga') == 'Pembantu' ? 'selected' : '' }}>Pembantu</option>
                                        <option value="Lainnya" {{ old('hubungan_kepala_keluarga') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('bulan_lahir') is-invalid @enderror" 
                                                ...
                                                <option value="">--</option>
                                                @for($i = 1; $i <= 12; $i++)
                                                    <option value="{{ $i }}" {{ old('bulan_lahir') == $i ? 'selected' : '' }}>
                                                        {{ $i }}
                                                    </option>
                                                @endfor
                                            </select>
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('tahun_lahir') is-invalid @enderror" 
                                                   id="tahun_lahir" name="tahun_lahir" value="{{ old('tahun_lahir') }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('suku') is-invalid @enderror" 
                                           id="suku" name="suku" value="{{ old('suku') }}">
                                    @error('suku')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('pendidikan_terakhir') is-invalid @enderror" 
                                        ...
                                        <option value="Tamat SD" {{ old('pendidikan_terakhir') == 'Tamat SD' ? 'selected' : '' }}>Tamat SD</option>
                                        ...
                                        <option value="D I/D II" {{ old('pendidikan_terakhir') == 'D I/D II' ? 'selected' : '' }}>D I/D II</option>
                                        <option value="D III" {{ old('pendidikan_terakhir') == 'D III' ? 'selected' : '' }}>D III</option>
                                        <option value="D IV/S1" {{ old('pendidikan_terakhir') == 'D IV/S1' ? 'selected' : '' }}>D IV/S1</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('mata_pencaharian') is-invalid @enderror" 
                                        ...
                                        <option value="Tidak Bekerja" {{ old('mata_pencaharian') == 'Tidak Bekerja' ? 'selected' : '' }}>Tidak Bekerja</option>
                                        <option value="Petani" {{ old('mata_pencaharian') == 'Petani' ? 'selected' : '' }}>Petani</option>
                                        <option value="Buruh Tani" {{ old('mata_pencaharian') == 'Buruh Tani' ? 'selected' : '' }}>Buruh Tani</option>
                                        ...
                                        <option value="Karyawan Swasta" {{ old('mata_pencaharian') == 'Karyawan Swasta' ? 'selected' : '' }}>Karyawan Swasta</option>
                                        <option value="PNS" {{ old('mata_pencaharian') == 'PNS' ? 'selected' : '' }}>PNS</option>
                                        <option value="TNI/Polri" {{ old('mata_pencaharian') == 'TNI/Polri' ? 'selected' : '' }}>TNI/Polri</option>
                                        <option value="IRT" {{ old('mata_pencaharian') == 'IRT' ? 'selected' : '' }}>Ibu Rumah Tangga</option>
                                        <option value="Pelajar/Mahasiswa" {{ old('mata_pencaharian') == 'Pelajar/Mahasiswa' ? 'selected' : '' }}>Pelajar/Mahasiswa</option>
                                        <option value="Lainnya" {{ old('mata_pencaharian') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('pekerjaan_tambahan') is-invalid @enderror" 
                                           id="pekerjaan_tambahan" name="pekerjaan_tambahan" value="{{ old('pekerjaan_tambahan') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('alamat_kartu_keluarga') is-invalid @enderror" 
                                              id="alamat_kartu_keluarga" name="alamat_kartu_keluarga" rows="3" required>{{ old('alamat_kartu_keluarga') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_kk_dikeluarkan') is-invalid @enderror" 
                                           id="tanggal_kk_dikeluarkan" name="tanggal_kk_dikeluarkan" value="{{ old('tanggal_kk_dikeluarkan') }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" id="kendaraan_mobil" name="kendaraan_mobil" value="1" {{ old('kendaraan_mobil') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="kendaraan_mobil">Mobil</label>
                                </div>

                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" id="kendaraan_motor" name="kendaraan_motor" value="1" {{ old('kendaraan_motor') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="kendaraan_motor">Motor</label>
                                </div>

                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" id="kendaraan_sepeda" name="kendaraan_sepeda" value="1" {{ old('kendaraan_sepeda') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="luas_lahan_pertanian" name="luas_lahan_pertanian" 
                                           value="{{ old('luas_lahan_pertanian', 0) }}" min="0" step="0.01">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="luas_lahan_peternakan" name="luas_lahan_peternakan" 
                                           value="{{ old('luas_lahan_peternakan', 0) }}" min="0" step="0.01">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="komoditas_buah_sayur" name="komoditas_buah_sayur" 
                                           value="{{ old('komoditas_buah_sayur') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="kepemilikan" name="kepemilikan">
                                        ...
                                        <option value="Milik Sendiri" {{ old('kepemilikan') == 'Milik Sendiri' ? 'selected' : '' }}>Milik Sendiri</option>
                                        <option value="Kontrak" {{ old('kepemilikan') == 'Kontrak' ? 'selected' : '' }}>Kontrak</option>
                                        <option value="Sewa" {{ old('kepemilikan') == 'Sewa' ? 'selected' : '' }}>Sewa</option>
                                        <option value="Bebas Sewa" {{ old('kepemilikan') == 'Bebas Sewa' ? 'selected' : '' }}>Bebas Sewa</option>
                                        <option value="Lainnya" {{ old('kepemilikan') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status_rumah_dinding" name="status_rumah_dinding">
                                        ...
                                        <option value="Tembok" {{ old('status_rumah_dinding') == 'Tembok' ? 'selected' : '' }}>Tembok</option>
                                        <option value="Kayu" {{ old('status_rumah_dinding') == 'Kayu' ? 'selected' : '' }}>Kayu</option>
                                        <option value="Bambu" {{ old('status_rumah_dinding') == 'Bambu' ? 'selected' : '' }}>Bambu</option>
                                        <option value="Campuran" {{ old('status_rumah_dinding') == 'Campuran' ? 'selected' : '' }}>Campuran</option>
                                        <option value="Lainnya" {{ old('status_rumah_dinding') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status_rumah_atap" name="status_rumah_atap">
                                        ...
                                        <option value="Genteng" {{ old('status_rumah_atap') == 'Genteng' ? 'selected' : '' }}>Genteng</option>
                                        <option value="Seng" {{ old('status_rumah_atap') == 'Seng' ? 'selected' : '' }}>Seng</option>
                                        <option value="Asbes" {{ old('status_rumah_atap') == 'Asbes' ? 'selected' : '' }}>Asbes</option>
                                        <option value="Lainnya" {{ old('status_rumah_atap') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status_rumah_listrik" name="status_rumah_listrik">
                                        ...
                                        <option value="Ada" {{ old('status_rumah_listrik') == 'Ada' ? 'selected' : '' }}>Ada</option>
                                        <option value="Tidak Ada" {{ old('status_rumah_listrik') == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="status_rumah_mck" name="status_rumah_mck">
                                        ...
                                        <option value="Sendiri" {{ old('status_rumah_mck') == 'Sendiri' ? 'selected' : '' }}>Sendiri</option>
                                        <option value="Bersama" {{ old('status_rumah_mck') == 'Bersama' ? 'selected' : '' }}>Bersama</option>
                                        <option value="Tidak Ada" {{ old('status_rumah_mck') == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="status_bantuan" name="status_bantuan" value="1" {{ old('status_bantuan') ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const bulanLahir = document.getElementById('bulan_lahir');
    const tahunLahir = document.getElementById('tahun_lahir');
    
    function calculateAge() {
        const tanggal = parseInt(tanggalLahir.value);
        const bulan = parseInt(bulanLahir.value);
        const tahun = parseInt(tahunLahir.value);
    ...
    [tanggalLahir, bulanLahir, tahunLahir].forEach(input => {
